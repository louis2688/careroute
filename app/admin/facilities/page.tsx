...
export default async function FacilitiesPage() {
  ...
  return (
    <div className="pb-10">
      <div className="mt-6">
        <h1 className="font-heading text-3xl font-bold tracking-tight text-slate-900">Facilities</h1>
      ...
      <details className="mt-6 rounded-xl border border-slate-200 bg-white p-4">
        <summary className="cursor-pointer font-medium text-slate-900">Add a facility</summary>
            ...
            <tbody className="divide-y divide-slate-100">
              {facilities.map((f) => (
                <tr key={f.id}>
                  ...
                  <td className="px-4 py-3 font-mono text-slate-900">{f.access_code}</td>
                </tr>
              ))}
            </tbody>
          </table>
